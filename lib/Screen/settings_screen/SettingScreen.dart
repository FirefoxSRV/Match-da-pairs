          ...
          slivers: [
            SliverAppBar(
                ...
                bottom: PreferredSize(
                    ...
                    child: Text(
                      "Settings ",
                      style: GoogleFonts.quicksand(fontSize: 40.0,fontWeight: FontWeight.w500,color: Colors.white),
                    ))),
            SliverToBoxAdapter(
                child:SizedBox(
                      ...
                      Padding(
                        ...
                        child: Text("Store your data locally !",
                            style: GoogleFonts.quicksand(
                                fontSize: 20.0, fontWeight: FontWeight.bold,color: bodyTextColor)),
                      ),
                      Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Icon(Icons.home,color: bodyTextColor,),
                          ),
                          ...
                          Expanded(
                            child: Text(
                              ...
                              style: GoogleFonts.quicksand(fontSize: 16.0,color: bodyTextColor),),
                          ),
                        ],
                      ),
                    ],
